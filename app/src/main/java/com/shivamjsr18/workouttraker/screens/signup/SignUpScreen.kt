...
fun SignUpScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(title = { Text(text = "Sing Up")})
        }
    ){paddingValues ->
        Column(
            modifier = Modifier
            ...
            OutlinedTextField(
                ...
                leadingIcon = { Icon(imageVector = Icons.Default.Lock, contentDescription = "Repeat Password") },
                keyboardOptions = KeyboardOptions(
                    imeAction = ImeAction.Done,
                    keyboardType = KeyboardType.Password),
                visualTransformation = visualTransformation
            ...
            Button(
                onClick = { viewModel.onSignUpClick(openSetting,snackbarHostState) },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(start = 54.dp, end = 54.dp),
